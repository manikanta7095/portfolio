...
import {logo,menu,close } from '/src/asserts/assets'
...
const Navbar = () => {
  ...
  return (
    ...
    items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex jsutify-between items-center
      max-w-7xl mx-auto'>
        ...
        font-bold cursor-pointer flex'>Chethan <span className='sm:block hidden'>| Manikanta</span></p>
        </Link>
